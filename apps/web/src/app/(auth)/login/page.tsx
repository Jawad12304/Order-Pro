...
export default function LoginPage() {
  ...
  const handleSignUp = async () => {
    ...
    if (error) {
      ...
      // Typically you'd redirect to onboarding after sign up
    ...
    <div className="flex min-h-screen items-center justify-center bg-zinc-950 p-4">
      <div className="w-full max-w-md space-y-8 rounded-2xl bg-zinc-900 p-8 shadow-xl border border-zinc-800">
        <div className="text-center">
          <h2 className="text-3xl font-bold tracking-tight text-white">Order Pro</h2>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleLogin}>
          ...
          <div className="flex flex-col gap-3">
            ...
            <button
              ...
              disabled={loading}
              className="flex w-full justify-center rounded-lg border border-zinc-700 bg-transparent px-4 py-2.5 text-sm font-semibold text-white hover:bg-zinc-800 focus:outline-none transition-colors"
            >
              Create Account
            </button>
          </div>
        ...
        <div className="mt-6">
          ...
          <div className="mt-6">
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-lg border border-zinc-700 bg-zinc-800/30 px-4 py-2.5 text-sm font-semibold text-white hover:bg-zinc-800 focus:outline-none transition-colors"
            >
